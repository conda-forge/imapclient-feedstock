...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/imapclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/imapclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install imapclient
```
...
It is possible to list all of the versions of `imapclient` available on your platform:
...
```
pixi search imapclient --channel conda-forge
```
